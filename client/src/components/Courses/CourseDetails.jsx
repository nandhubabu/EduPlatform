...
export default function CourseDetails() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans antialiased pb-24">
      {/* ─── 1. HERO BANNER (Clean Light Aesthetic) ─────────── */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <main className="lg:col-span-8 space-y-10">
            {/* Alert Toast */}
            {enrollMsg && (
              <div className="p-4 rounded-xl bg-indigo-50 border border-indigo-200 text-indigo-800 text-sm font-semibold flex items-center gap-2 animate-fadeIn">
                <FaCheckCircle className="text-base text-indigo-600" />
                <span>{enrollMsg}</span>
              </div>
            )}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {outcomes.map((outcome, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    <FaCheck className="text-emerald-500 text-sm flex-shrink-0 mt-1" />
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 pb-2">
                <div>
                  <h2 className="text-2xl font-black text-slate-900">Course content</h2>
          ...
          {/* ─── RIGHT FLOATING STICKY ENROLLMENT CARD (Coursera / Udemy Signature) ─── */}
            ...
            <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="relative aspect-video bg-slate-100">
                ...
                <div className="absolute inset-0 bg-slate-900/30 flex flex-col items-center justify-center text-white gap-2">
                  <div className="w-14 h-14 rounded-full bg-white text-indigo-600 flex items-center justify-center shadow-2xl hover:scale-110 transition-transform">
                ...
                <div>
                  {isEnrolled ? (
                    <Link
                      ...
                      className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-xl flex items-center justify-center gap-2 transition shadow-md no-underline"
                    >
                    ...
                    <Link
                      to={`/courses/${courseId}/learn`}
                      className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-sm rounded-xl flex items-center justify-center gap-2 transition shadow-md no-underline"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-black text-base rounded-xl transition shadow-md flex items-center justify-center gap-2"
                    >
                ...
                <div className="pt-4 border-t border-slate-100 space-y-3">
                  ...
                  <ul className="space-y-2.5 text-xs text-slate-600">
                    <li className="flex items-center gap-3">
                      <FaPlay className="text-indigo-600 flex-shrink-0" />
                      <span>{estimatedHours} hours on-demand video</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <FaFileAlt className="text-indigo-600 flex-shrink-0" />
                      <span>{totalLectures} downloadable resources & guides</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <FaInfinity className="text-indigo-600 flex-shrink-0" />
                      <span>Full lifetime access</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <FaTv className="text-indigo-600 flex-shrink-0" />
                      <span>Access on mobile, tablet, and TV</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <FaAward className="text-indigo-600 flex-shrink-0" />
